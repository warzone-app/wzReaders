    ...
    return (
      <div id="landingContainer">
        <div id="imageAndSearchContainer">
          <img id="WZLogo" src="/images/WZLogo3.png" alt="WZ Logo" />
            ...
            <div id="cover">
              <form id="landingForm">
                <div className="inputContainer">
                  ...
                  />
                  <Link
                    to={`/playerstats?user=${this.props.username}&platform=${this.props.platform}`}
                  >
          ...
          <div id="popularDiv">
            ...
            <div id="popularPlayerContainer">
              {topPlayers.map((el, i) => {
                return (
                  <div className="singlePopPlayContainer" key={i}>
                    <Link
                      to={el.link}
                      className="ImgNameContainer"
                      id={el.id}
                      onClick={this.handleClickUser}
                    >
                      <img alt="" className="topPlayerImg" src={el.img} />
                      <div className="topPlayerName">{el.name}</div>
                    </Link>
                    <div id="SMContainer">
                      <img
                        alt=""
                        className="topPlayerSMImg"
                        id={el.twitch}
